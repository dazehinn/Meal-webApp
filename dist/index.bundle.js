...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n  if (!url) {\n    return url;\n  }\n  url = String(url.__esModule ? url.default : url);\n\n  // If url is already wrapped in quotes, remove them\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n  if (options.hash) {\n    url += options.hash;\n  }\n\n  // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n  return url;\n};\n\n//# sourceURL=webpack://meal-webapp/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
/***/ "./src/fonts/Booter - Zero Zero.woff":
/*!*******************************************!*\
  !*** ./src/fonts/Booter - Zero Zero.woff ***!
  \*******************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"41f859064b81b62a73f7.woff\";\n\n//# sourceURL=webpack://meal-webapp/./src/fonts/Booter_-_Zero_Zero.woff?");

/***/ }),

/***/ "./src/fonts/Booter - Zero Zero.woff2":
/*!********************************************!*\
  !*** ./src/fonts/Booter - Zero Zero.woff2 ***!
  \********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"388e58d6969676c0fdb1.woff2\";\n\n//# sourceURL=webpack://meal-webapp/./src/fonts/Booter_-_Zero_Zero.woff2?");
